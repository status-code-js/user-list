...
export const User = () => (
    <li>
        <div>
            <img className="user-photo" src="https://reqres.in/img/faces/1-image.jpg" alt="user-photo"/>
            <div>
                <h3>Adam Smith</h3>
                <p>
                ...
                adam.smith@reqres.in
                </p>
            </div>
        </div>
        <img className="event" src="./assets/plus.svg" alt="event"/>
    </li>
)